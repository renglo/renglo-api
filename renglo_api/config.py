...
def load_env_config(config_path=None):
    ...
    env_var_keys = [
        ...
        'FROM_EMAIL',
        'APP_FE_BASE_URL', 'ROLE_ARN', 'EVENTBRIDGE_EMULATOR_URL',
        ...
        'RENGLO_INGRESS_SECRET', 'WEBHOOK_EDGE_BASE_URL',
...
def get_config_for_lambda():
    ...
    env_var_keys = [
        ...
        'GRAPH_DB_ENABLED',
        'COGNITO_REGION', 'COGNITO_USERPOOL_ID', 'COGNITO_APP_CLIENT_ID',
        'OPENAI_API_KEY', 'WEBSOCKET_CONNECTIONS', 'BASE_URL', 'FE_BASE_URL',
        'INVITE_FE_BASE_URL', 'FROM_EMAIL',
